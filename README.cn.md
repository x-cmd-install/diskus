...
[![x-cmd/install — diskus Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/diskus.svg?lang=zh)](https://x-cmd.com/install/diskus)
...
- **上游仓库**: <https://github.com/sharkdp/diskus>
- **许可证**: Apache-2.0
...
- **Star**: 1,246 · **Fork**: 46 · **开放 issue**: 34 · **贡献者**: 12
...
| 360d | 2025-10-01 | 1 | 4 | 3 | 0 | 1 | 20 |
| last720d | 2024-10-06 | 2 | 5 | 4 | 0 | 1 | 27 |
...
diskus 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `diskus` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/diskus.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260926.yml` · 2026-09-26T05:16:45Z._
